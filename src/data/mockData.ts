...
// Mock Learning Modules for AI Assistant
export const mockModules: Module[] = [
  {
    id: 'cs101-basics',
    name: 'Programming Fundamentals',
    topics: ['Variables', 'Data Types', 'Control Flow', 'Functions', 'Objects'],
    courseId: '1'
  },
  {
    id: 'cs101-algorithms',
    name: 'Basic Algorithms',
    topics: ['Sorting', 'Searching', 'Recursion', 'Time Complexity'],
    courseId: '1'
  },
  {
    id: 'math204-linear',
  ...
  },
  {
    ...
    topics: ['Documentation Structure', 'API Documentation', 'User Guides', 'Technical Reports'],
    courseId: '4'
  }
];
